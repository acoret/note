...
## global command -> {query: ("user" | "game")}, response -> user: {name: "name"}, game: {success: true, version: "uuid-123123-1231231", }.{login: {username: "name", password: "hashed password", salt: "salt"}} -> {success: true}
